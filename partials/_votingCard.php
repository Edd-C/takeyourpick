<div class="container-fluid">
				...
				<table class="table table-bordered table-dark">
					...
					<tr>
						<td class="text-center bg-white text-dark font-weight-bold" style="font-size:1.5em;">
							<p class="m-0 p-0" id="upVoteDetails_<?= $personInital.$versionNumber; ?>"><?= $votes['up']; ?></p>
						...
						<td class="text-center bg-white text-dark font-weight-bold" style="font-size:1.5em;">
							<p class="m-0 p-0" id="downVoteDetails_<?= $personInital.$versionNumber; ?>"><?= $votes['down']; ?></p>
	...
	<div class="row">
		<button type="button" class="btn btn-danger w-100 py-4" onclick="downVote('<?= $fileName; ?>', <?= $versionNumber; ?>)">

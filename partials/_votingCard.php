...
?>
		...
		<div class="container-fluid">
			...
			<div class="pt-3" style="margin:0 -15px 0 -15px; position: relative;">
				<p class="display-4 font-weight-bold" style="color: white; position: absolute; top: 20px; left: 20px; text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -2px black;"> CK 1</p>
				<img src="images/CK1.jpg" class="img-fluid" alt="Responsive image">
			</div>
				...
				<?php foreach($people as $personId => $person) { ?>
					<div class='d-inline-block' style='width: 20%;'>
						<table class="table table-bordered table-dark">
							<thead>
								<tr>
									<th colspan="2" class="text-center display-4 font-weight-bold"><?= $personId; ?></th>
								</tr>
							</thead>
			...
			<div class="row">
				<p class="" style="font-size:10px; font-style: italic;"> (Total = all up votes - all down votes)</p>
			</div>

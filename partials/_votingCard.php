<div class="container-fluid">
	...
	<!-- Voting Buttons -->
	<div class="row mb-3">
		<button type="button" class="btn btn-success w-100 py-4" ontouchstart="upVote('<?= $fileName; ?>', <?= $versionNumber; ?>)">
	...
	<div class="row">
		<button type="button" class="btn btn-danger w-100 py-4" ontouchstart="downVote('<?= $fileName; ?>', <?= $versionNumber; ?>)">

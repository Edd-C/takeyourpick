<div class="card" >
	<div class="card-body">
		<div class="container-fluid">
			<div class="pt-3" style="margin:0 -15px 0 -15px;">
			...
			<div class="row pt-3">
				<div class='col-3 pl-0 pr-2'>
					<table class="table table-bordered table-dark">
						<thead>
							<tr>
								<th colspan="2" class="text-center">CK</th>
							</tr>
						</thead>

						<tbody>
						<tr>
							<td class="text-center bg-white text-dark font-weight-bold">
								0
				...
				<div class='col-3 px-2'>
					<table class="table table-bordered table-dark">
						<thead>
							<tr>
								<th colspan="2" class="text-center">TK</th>
							</tr>
						</thead>
				...
				<div class='col-3 px-2'>
					<table class="table table-bordered table-dark">
						<thead>
							<tr>
								<th colspan="2" class="text-center">SL</th>
							</tr>
						</thead>
				...
				<div class='col-3 pl-2 pr-0'>
					<table class="table table-bordered table-dark">
						<thead>
							<tr>
								<th colspan="2" class="text-center">KB</th>
							</tr>
						</thead>
			...
			<div class="row mb-2">
				<button type="button" class="btn btn-success w-100 py-3" onclick="test();">
